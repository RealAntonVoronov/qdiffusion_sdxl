...
class QuantModel(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, added_cond_kwargs=None, **kwargs):
        return self.model(x, timesteps, context, added_cond_kwargs=added_cond_kwargs, **kwargs)
